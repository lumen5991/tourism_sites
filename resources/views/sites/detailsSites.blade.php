        ...
        <div class="container-fluid page-header-event">
            <div class="container">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 500px">
                    <h3 class="display-4 text-white text-uppercase">Détails Sites</h3>
                    <div class="d-inline-flex text-white">
                        <p class="m-0 text-uppercase"><a class="text-white" href="">Acceuil</a></p>
                        <i class="fa fa-angle-double-right pt-1 px-3"></i>
                        <p class="m-0 text-uppercase">Détails Sites</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div>
                                <div class="pb-3">
                                    ...
                                    <div class="bg-white mb-3" style="padding: 30px;">
                                        ...
                                        <div>
                                            <div>
                                                <p class="text-justify">Sadipscing labore amet rebum est et justo gubergren.
                                                    ...
                                                    et at at
                                                    sanctus et. Ipsum sit gubergren dolores et, consetetur justo invidunt at
                                                    et
                                                    aliquyam ut et vero clita. Diam sea sea no sed dolores diam nonumy,
                                                    gubergren
                                        ...
                                        <div class="pt-2">
                                            <p>Publier par : <a href="" class="font-weight-bold text-uppercase text-decoration-none text-black">AHLE Rolande</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
