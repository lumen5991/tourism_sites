    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase font-weight-bold" style="letter-spacing: 5px;">Ajouter un évènement</h6>
                    ...
                    <div class="contact-form bg-white" style="padding: 50px;">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="event-title" placeholder="Entrez le titre de l'événement">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="event-location" placeholder="Entrez la localisation de l'événement">
                            </div>
                            <div class="form-group">
                                <label for="event-organizer">Organisateur</label>
                                <input type="text" class="form-control" id="event-organizer" placeholder="Entrez le nom de l'organisateur">
                            </div>
                            <div class="form-group">
                                <label for="event-poster">Affiche de l'événement</label>
                                <input type="file" class="form-control-file" id="event-poster">
                                <small id="event-poster-help" class="form-text text-muted">Téléchargez les affiches de l'événement au format image (jpg, png, etc.).</small>
                            </div>
                            <div>
                                <button class="btn btn-primary btn-block py-3" type="submit" style="font-weight: bold">Ajouter évènement</button>
                            </div>
                        </form>
                    </div>
                </div>
